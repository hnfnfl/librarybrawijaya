			...
			<div class="item-slick2">
				<div class="wrap3">
					<section class="login_box_area p_120">
						<div class="container">
							<?php
							if ($this->input->cookie('alert', TRUE) == 1) { ?>
								<div class="alert warning">
									<span class="closebtn">&times;</span>
									<strong>Warning!</strong> User telah terdaftar sebelumnya, silahkan Login!
								</div>
							<?php
							} elseif ($this->input->cookie("alert", true) == 1) { ?>
								<div class="alert">
									<span class="closebtn">&times;</span>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="login_form_inner">
										<h3>Log in Staff</h3>
										<form class="row login_form" action="<?php echo site_url('controller/authStaff') ?>" method="post" id="login">
