...
<body class="animsition">
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('<?php echo base_url(); ?>asset/images/library03.jpg');">
		...
		<div class="container">
			<div class="bor10 flex-w flex-col-m p-lr-50 p-tb-30 p-lr-15-lg w-full-md">
				<div class="flex-w w-full p-b-42">
					<form class="w-full" action="<?php echo site_url('controller/transaksi') ?>" method="post">
						<h3 class="p-b-25 txt-center">Input Data Peminjam dan Buku</h3>
						<?php
						if ($this->session->userdata('nim') && $this->session->userdata('judul')) { ?>
						<h6>NIM</h6>
							<div class="form-wrapper">
								<input type="text" placeholder="NIM" name="nim" class="form-control m-b-20" value="<?php
																														if ($this->session->userdata('nim')) {																								echo "$_SESSION[nim]";
																														} ?>" readonly required />
							</div>
							<h6>Nama Lengkap</h6>
							<div class="form-wrapper">
								<input type="text" placeholder="Nama Lengkap"  name="nama" class="form-control m-b-20" value="<?php
																														if ($this->session->userdata('nama')) {
																															echo "$_SESSION[nama]";
																														} ?>" readonly required />
							</div>
							<h6>Kode Buku</h6>
							<div class="form-wrapper">
								<input type="text" placeholder="Kode" name="kode_buku" class="form-control m-b-20" value="<?php echo $posts[0]->kode_buku ?>" readonly required />
							</div>
							<h6>Judul Buku</h6>
							<div class="form-wrapper">
								<input type="text" placeholder="Judul" class="form-control m-b-20" value="<?php echo $posts[0]->judul ?>" readonly required />
							</div>
							<h6>Tanggal Pinjam</h6>
							<div class="form-wrapper">
								<input placeholder="Tanggal Pinjam" name="tanggal_pinjam" class="textbox-n form-control m-b-20" type="text" onfocus="(this.type='date')" required>
							</div>
							<h6>Tanggal Kembali</h6>
							<div class="form-wrapper">
								<input placeholder="Tanggal Kembali" name="tanggal_kembali" class="textbox-n form-control m-b-20" type="text" onfocus="(this.type='date')" required>
							</div>
							<button type="submit" class="submit_btn" name="pinjam">
								PINJAM BUKU
							</button>
						...
						<?php
							...
							<h2 class="p-b-25 m-t-20 txt-center text-danger">
								Mohon Maaf, Silahkan login dan pilih buku terlebih dahulu.
							</h2>
