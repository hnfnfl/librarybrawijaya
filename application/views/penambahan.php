		...
		<div class="container">
			<div class="bor10 flex-w flex-col-m p-lr-50 p-tb-30 p-lr-15-lg w-full-md">
				<div class="flex-w w-full p-b-42">
					<form class="w-full" action="<?php echo site_url('controller/tambahBuku') ?>" method="post">
						<h3 class="p-b-25 txt-center">Input Data Buku</h3>

						<?php
						if ($this->session->userdata('status')) { ?>

							<div class="form-wrapper">
								<input type="text" placeholder="Kode" name="kode_buku" class="form-control  m-b-20" required />
							</div>
							<div class="form-wrapper">
								<input type="text" placeholder="Judul" name="judul" class="form-control m-b-20" required />
							</div>
							<div class="form-wrapper">
								<select name="kategori" class="form-control m-b-20">
									<option value="">Kategori</option>
									<option value="Buku Masakan">Buku Masakan</option>
									<option value="Buku Medis">Buku Medis</option>
									...
									<option value="Psiokologi">Psiokologi</option>
							...
							<div class="form-wrapper">
								<input type="text" placeholder="Penerbit" name="penerbit" class="form-control m-b-20" required />
							</div>
							<div class="form-wrapper">
								<input type="text" placeholder="Penulis" name="penulis" class="form-control m-b-20" required />
							</div>
							<div class="form-wrapper">
								<input type="text" placeholder="Cover (url)" name="cover_buku" class="form-control m-b-20" />
							</div>
						...
						<?php
							...
							<h2 class="p-b-25 txt-center  text-danger">
								Mohon Maaf, Penambahan buku hanya dapat dilakukan oleh staff perpustakaan.
							</h2>
