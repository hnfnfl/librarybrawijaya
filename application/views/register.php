...
<head>
	<title>Registrasi - Library Brawijaya</title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('<?php echo base_url(); ?>asset/images/register02.png');">
		...
		<div class="container">
			...
			<?php
				...
				<div class="alert">
					...
					<strong>Error!</strong> Username Ini Sudah Terdaftar!
				</div>
			<?php
			} elseif ($data['alert'] == 2) { ?>
				<div class="alert warning">
					<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
					<strong>Perhatian!</strong> Password Tidak Cocok!
				</div>
			<?php } ?>
			<div class="bor10 flex-w flex-col-m p-lr-50 p-tb-30 p-lr-15-lg w-full-md">
				<div class="flex-w w-full p-b-42">
					<form class="w-full" action="<?php echo site_url('controller/registrasi') ?>" method="post">
						<h3 class="p-b-25 txt-center">FORM PENDAFTARAN</h3>
						<div class="form-wrapper">
							<input type="text" name="username" placeholder="NIM (sebagai username nantinya)" class="form-control m-b-20" required />
						</div>
						<div class="form-wrapper">
							<input type="text" name="nama" placeholder="Nama Lengkap" class="form-control m-b-20" required />
						</div>
						<div class="form-wrapper">
							<input type="email" name="email" placeholder="Email" class="form-control m-b-20" required />
						</div>
						<div class="form-wrapper">
							<input type="text" name="alamat" placeholder="Alamat" class="form-control m-b-20" required />
						</div>
						<div class="form-wrapper">
							<input type="number" name="telp" placeholder="Nomor Telepon" class="form-control m-b-20" required />
						</div>
						<div class="form-wrapper">
							<input type="password" name="password" placeholder="Password" class="form-control m-b-20" required />
						</div>
						<div class="form-wrapper">
							<input type="password" name="confirmpass" placeholder="Confirm Password" class="form-control m-b-20" required />
						</div>
						<p>
							Dengan meng-klik tombol daftar, saya menyetujui
							<a href="<?php echo site_url('controller/viewSyarat') ?>">syarat dan ketentuan</a> yang berlaku
						</p><br>
						<button type="submit" class="submit_btn" name="register">
							REGISTER
						</button>
					</form>
				</div>
