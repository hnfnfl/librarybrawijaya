			...
			<div class="bor10 flex-w flex-col-m p-lr-50 p-tb-30 p-lr-15-lg w-full-md">
				<div class="flex-w w-full p-b-42">
					<form class="w-full" action="<?php echo site_url('controller/transaksi') ?>" method="post">
						...
						<img src="https://i.ibb.co/dKSSbcp/checked.png" class="m-t-50 rounded mx-auto d-block" alt="IMG-PRODUCT">
						<?php
						if ($this->session->flashdata('pesanTransaksi1')) { ?>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanTransaksi1]</p>"; ?>
							</h2>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanTransaksi2]</p>"; ?>
							</h2>
						<?php
						} else  if ($this->session->flashdata('pesanPenambahan1')) { ?>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanPenambahan1]</p>"; ?>
							</h2>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanPenambahan2]</p>"; ?>
							</h2>
						<?php
						} else  if ($this->session->flashdata('pesanPengembalian1')) { ?>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanPengembalian1]</p>"; ?>
							</h2>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanPengembalian2]</p>"; ?>
							</h2>
						<?php
						} else  if ($this->session->flashdata('pesanRegistrasi1')) { ?>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanRegistrasi1]</p>"; ?>
							</h2>
							<h2 class="p-b-25 m-t-20 txt-center text-success">
								<?php echo "<p>$_SESSION[pesanRegistrasi2]</p>"; ?>
							</h2>
						<?php
						} ?>
